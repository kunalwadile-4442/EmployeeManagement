        ...
        <div className="fixed inset-0 z-20 flex items-center justify-center bg-gray-500 bg-opacity-75">
            <div className="bg-white p-6 rounded-md shadow-lg w-1/3">
                ...
                <div className="flex justify-end space-x-4">
                    <button
                        onClick={onCancel}
                        className="bg-purple-300 hover:bg-purple-400 text-gray-800 font-semibold py-2 px-4 rounded-md"
                    >
                        Cancel
                    </button>
                    <button
                        onClick={onSubmit}
                        className="bg-logo-text-color hover:bg-light-logo-color text-white font-semibold py-2 px-4 rounded-md"
                    >
                        Submit
                    </button>
                </div>
